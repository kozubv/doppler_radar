...
tgOpt.rotFreq     = 9;                  % частота вращения пропеллера
% --- moving options
tgOpt.absVelocity   = 0;                % модуль скорости 
...
rdOpt.windowsFftLen     = 128/4;          % размер окна в STFT
...
% -------------------------------------------------------------------------
% --- Execution
timeSimulation = 2/tgOpt.rotFreq;                 % время моделирования 
