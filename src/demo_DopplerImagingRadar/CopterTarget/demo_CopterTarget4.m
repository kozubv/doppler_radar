...
% --- moving options
tgOpt.absVelocity   = 50;                % модуль скорости 
...
% --- options TraceCircle 
tgOpt.traceRadius   = 0.5;                % радиус окружности для круговой траектории
...
% -------------------------------------------------------------------------
% --- Execution
timeSimulation = 10/tgOpt.rotFreq;                 % время моделирования 


% временной шаг моделирования
timeStep = 32 / rdOpt.pulseRate;
tPause = 0.1;
